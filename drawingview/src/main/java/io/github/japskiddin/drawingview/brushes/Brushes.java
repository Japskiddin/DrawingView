...
import io.github.japskiddin.drawingview.R;
import io.github.japskiddin.drawingview.brushes.androidpathbrushes.Eraser;
import io.github.japskiddin.drawingview.brushes.androidpathbrushes.Pen;
import io.github.japskiddin.drawingview.brushes.stampbrushes.BitmapBrush;
import io.github.japskiddin.drawingview.brushes.stampbrushes.Calligraphy;
import io.github.japskiddin.drawingview.brushes.stampbrushes.RandRotBitmapBrush;
  ...
  public Brush getBrush(int brushID) {
    if (brushID >= mBrushes.length || brushID < 0) {
      throw new IllegalArgumentException(
          "There is no brush with id = " + brushID + " in " + getClass());
    }
