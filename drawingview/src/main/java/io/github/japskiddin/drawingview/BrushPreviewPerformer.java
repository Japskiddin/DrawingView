...
import io.github.japskiddin.drawingview.brushes.Brush;
import io.github.japskiddin.drawingview.brushes.BrushSettings;
import io.github.japskiddin.drawingview.brushes.Brushes;
import io.github.japskiddin.drawingview.brushes.androidpathbrushes.Eraser;
import io.github.japskiddin.drawingview.brushes.androidpathbrushes.PathBrush;
import io.github.japskiddin.drawingview.brushes.stampbrushes.StampBrush;
  ...
  private List<float[]> initializeCurve(Context context, int w, int h) {
    ...
    float approximatedArcLength =
        Utilities.dist(curvePoints[0][0], curvePoints[0][1], curvePoints[1][0], curvePoints[1][1]) +
            Utilities.dist(curvePoints[1][0], curvePoints[1][1], curvePoints[2][0],
                curvePoints[2][1]) +
            Utilities.dist(curvePoints[2][0], curvePoints[2][1], curvePoints[3][0],
                curvePoints[3][1]);
